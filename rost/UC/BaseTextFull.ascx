<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="BaseTextFull.ascx.cs" Inherits="shop_health.UC.BaseTextFull" %>
            ...
            <ItemTemplate>
               <div class="media well" id="BaseText_blok" runat="server">
                   ...
                   <div class="row">
                       ...
                       <div>
                           <asp:HyperLink ID="HyperLinkText" runat="server" NavigateUrl="#"><h4>

                               <b><span>
                                   <asp:Label ID="LabelHeader_text" runat="server" Text='<%# Bind("header_text") %>'></asp:Label></span></b></h4>
