...
namespace root.UC
{
    public partial class ProductBlocks : System.Web.UI.UserControl
    {
        ...
        protected void Replist1_ItemDataBound(object sender, RepeaterItemEventArgs e)
        {
               ...
               (e.Item.ItemType == ListItemType.AlternatingItem))
            {
                ...
                Abtn.Text = @"<button class=""btn btn-warning add_item"" data-id=""" + data_id + @""" data-title=""" + name_item + @""" data-price=""" + price + @""" data-img=""" + "./../photoDB.ashx?type_img=" + "news" + "&items=" + items + @""" data-count=""1"" data-maxcount="""+MaxCount+@"""> <i class=""glyphicon glyphicon-credit-card""></i> В корзину</button>";
