...
namespace rost.UC
{
    public partial class OurProjects : System.Web.UI.UserControl
    {
...
FROM BaseText
WHERE id_pages=4 and visible_blok=1 ORDER BY npp, id_text desc;
...
//                }
                ...
                if (((Label)e.Item.FindControl("LabelItemHave_img")).Text == "True")
                {
                    ...
                    ((Image)e.Item.FindControl("ImageItem")).ImageUrl = "./../photoDB.ashx?type_img=image_lowCA&items=" + items + "&w=520&h=445";
                }
                else
                {
