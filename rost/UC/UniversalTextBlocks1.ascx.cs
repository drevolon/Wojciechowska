...
namespace root.UC
{
    public partial class UniversalTextBlocks : System.Web.UI.UserControl
    {
...
//                    ((Image)e.Item.FindControl("ImageItem")).ImageUrl = "./../photoDB.ashx?type_img=" + type_img + "&id=" + id_images;
                    ...
                    ((Image)e.Item.FindControl("ImageItem")).ImageUrl = "./../photoDB.ashx?type_img=image_lowCA&items=" + items + "&w=364&h=180";
                }
                else
                {
