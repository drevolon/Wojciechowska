<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="UniversalTextFind.ascx.cs" Inherits="rost.UC.UniversalTextFind" %>
...
<div class="row mx-auto align-middle align-content-center align-items-center ">
    <%--<div class="col-12">
        <asp:HyperLink ID="HyperLinkHead" runat="server" NavigateUrl="#" Style="overflow: hidden; height: 180px;">
            ...
            <h1 class="text-center" style="color: #963582;">
...
<asp:SqlDataSource ID="SqlDataSourceBaseText" runat="server" ConnectionString="<%$ ConnectionStrings:rostConnectionString %>"
    SelectCommand="BaseTextFind" SelectCommandType="StoredProcedure">
    <SelectParameters>
        <asp:Parameter Name="id_pages" DefaultValue="1" />
        <asp:Parameter DefaultValue="#$%^" Name="mask" />
    </SelectParameters>
</asp:SqlDataSource>
