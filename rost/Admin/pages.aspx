    ...
    <div class="panel panel-info">
        ...
        <div class="panel-body">
            <div class="form-group">
                ...
                <div class="form-group">
                    <label for="TextBoxShortText">Список характеристик (через ;)</label>
                    <asp:TextBox ID="TextBoxParamsText" runat="server" CssClass="form-control" placeholder="номер" Width="100%"></asp:TextBox>
                </div>
            ...
            <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" GridLines="None" DataKeyNames="id" DataSourceID="SqlDataSourcePages" CssClass="table table-responsive table-condensed table-hover" OnRowDataBound="GridView1_RowDataBound">
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="Список характеристик" SortExpression="name_pages">
                        <EditItemTemplate>
                            <asp:TextBox ID="TextBoxEdiName_props" runat="server" Text='<%# Bind("text_pages") %>' CssClass="form-control"></asp:TextBox>
                        </EditItemTemplate>
                        <ItemTemplate>
                            <asp:Label ID="LabelItemName_props" runat="server" Text='<%# Bind("text_pages") %>'></asp:Label>
                        </ItemTemplate>
                        <ItemStyle Width="100%" />
                    </asp:TemplateField>
                </Columns>
