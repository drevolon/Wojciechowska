<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="OneTextBlocks_old.ascx.cs" Inherits="rost.UC.OneTextBlocks1" %>

<%--<div class="row mx-auto align-middle align-content-center align-items-center ">
    <div class="col-12">
        <asp:HyperLink ID="HyperLinkHead" runat="server" NavigateUrl="#" Style="overflow: hidden; height: 60px;">
