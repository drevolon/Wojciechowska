...
namespace rost
{
    public partial class Boot4 : System.Web.UI.MasterPage
    {
        ...
        {
            string StringRequest = SearhTextBox.Text;
            if (StringRequest=="")  StringRequest = SearhTextBox_sm.Text;
            Response.Redirect("~/PagesFind.aspx?id_pages=1&mask=" + StringRequest);
        }
    }
}